...
//verificar quem venceu, condição
...
//limpar o jogo, declarar o vencendor e atualiza o placar
...
//evento para seber se á 2 players ou IA
    ...
    for (let i = 0; i < boxes.length; i++) {
        ...
        if (boxes[i].childNodes[0] == undefined) {
            if (randonNumber <= 1) {
                ...
                counter++;// não pode ser execultado
                break;
            }
            //checagem de quantas estão preenchidas.          
        } else {
            filled++;//tem que ser menor que 9, porque só tem 9 casas.
        }
    }
